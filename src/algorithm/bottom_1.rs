...
매개변수 w1,w2,theta는 함수안에서 초기화 도고 가중치를 곱한 입력의 총합이 임곗값을 넘으면 1을 반환하고 그외에는 0을반환합니다.
...
다층 퍼셉트론은 단층 퍼셉트론으로는 표현하지 못한 것을 층을 하나 늘려 구할수 잇었습니다.
